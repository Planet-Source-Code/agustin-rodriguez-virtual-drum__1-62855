...
Public Canal_Preset(0 To 15) As parametros
Public Canal(0 To 15) As Integer
Public Canal_vazio As Integer
Public MIDIChannel As Integer
Public QT_itens As Integer
Public Não_processe As Integer
